<%-- 
    Document   : ModificarTrivia
    Created on : 21/10/2019, 11:14:26 AM
    Author     : APRENDIZ
--%>
    ...
    <body>
        ...
        <div id="perfil">
            <form action="trivia" method="post">
                <h1>Actualizar Trivia</h1>
                <center>
                    <%
                        String id = request.getParameter("EditarTrivia");

                        ConexionBD con = new ConexionBD();
                        con.ObtenerConexion();
                        String sql = "select * from tbl_trivia where id_trivia = '" + id + "'; ";
                    ...
                    <div id="tabla">
                        <table class="table  table-bordered thead-dark">
                            <thead class="thead-dark" >
                                <tr>
                                    <th scope="col"><label >Código: </label></th>
                                    <td><input type="text" name="txtId" class="form-control" required readonly="readonly" placeholder=" Ingrese el Id de la Trivia a Modificar" value="<%=rs.getString("id_trivia")%>"></td>
                            ...
                            <tbody class="thead-dark">
                                <tr>
                                    ...
                                    <td><input type="text" name="txtDescripcion" class="form-control" required placeholder="Ingrese el contenido de la Trivia" value="<%=rs.getString("contenido")%>"></td>

                                </tr>

                            </tbody>
                        </table>
                        <button class="btn btn-info btn-lg">Editar Trivia</button>
